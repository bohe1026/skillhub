...
export const APP_HEADER_BASE_CLASS_NAME =
  'sticky top-2 z-50 mx-3 flex items-center justify-between rounded-2xl border border-white/80 bg-white/86 px-4 py-3 shadow-[0_20px_50px_-38px_rgba(37,99,235,0.46)] backdrop-blur-xl transition-shadow duration-200 md:top-3 md:mx-5 md:px-8'
