...
describe('install-command', () => {
  ...
  it('renders a single neutral install command without branded method tabs', () => {
    setMockWindow('https://app.example.com')
